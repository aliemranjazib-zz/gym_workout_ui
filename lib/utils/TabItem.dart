        ...
        children: [
          ...
          Container(
            ...
            child: AnimatedAlign(
              ...
              child:InkWell(
                  child: Image.asset(ConstantData.assetHomeImagesPath+widget.image,color:widget.tabIconColor,
                  height: ConstantWidget.getPercentSize(65, 30),
                  ),
              ...
              //     icon: Image.asset(ConstantData.assetHomeImagesPath+activeImage!,color:Colors.white,
              //
