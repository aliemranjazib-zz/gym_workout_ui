...
class _TabStyle extends AnimatedWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle textStyle = defaultStyle;
...
class _TabBarState extends State<TabBar> {
 ...
 return widget.indicator;
  ...
  void _updateTabController() {
    final MotionTabController newController = widget.controller;
    assert(() {
  ...
  void _scrollToControllerValue() {
    final double leadingPosition =
        _currentIndex > 0 ? _tabCenteredScrollOffset(_currentIndex - 1) : 0;
    ...
    if (value == index - 1.0)
      ...
      offset = lerpDouble(middlePosition, leadingPosition, index - value)!;
    else
      offset = lerpDouble(middlePosition, trailingPosition, value - index)!;
...
class _TabBarViewState extends State<MotionTabBarView> {
  ...
  void _updateTabController() {
    print("controller0-------${widget.controller}");
    ...
    if (_controllerIsValid && _controller != null)
      _controller!.animation.removeListener(_handleTabControllerAnimationTick);
    _controller = newController!;
    _controller!.animation.addListener(_handleTabControllerAnimationTick);
  }
...
class TabPageSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final MotionTabController? tabController = controller!;
