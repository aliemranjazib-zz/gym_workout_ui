...
class MotionTabController extends ChangeNotifier {
  ...
  MotionTabController({required int initialIndex,this.length = 5, required TickerProvider vsync})
  ...
  void _changeIndex(int value, {Duration? duration, Curve? curve}) {
    ...
    if (duration != null) {
      ...
      _animationController!.animateTo(_index.toDouble(), duration: duration, curve: curve!)
