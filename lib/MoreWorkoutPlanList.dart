...
class MoreWorkoutPlanList extends StatefulWidget {
  final ModelPlanCategory planCategory;

  MoreWorkoutPlanList(this.planCategory);

  @override
  _MoreWorkoutPlanList createState() => _MoreWorkoutPlanList();
}

class _MoreWorkoutPlanList extends State<MoreWorkoutPlanList> {
    ...
    return WillPopScope(
      child: Scaffold(
        ...
        body: SafeArea(
          child: Stack(
            children: [
              ConstantWidget.getAppBar(context, widget.planCategory.name!, () {
                onBackClick();
              }),
              Container(
